...
export default function Header() {
  ...
  useClickOutside(refMenu, setViewMenu);
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener('scroll', shadow);
    };
  }, []);

  return (
    <>
      <header className={`${s.root} ${headerShadow ? s.headerShadow : ''}`}>
        <div className={s.mainContainer}>
          ...
          <div className={s.content}>
            <Search version={'Header'} />
            <Position version={'Header'} />
          </div>
          <div className={s.dataContainer}>
            {username ? (
              <div className={s.orders__usersContainer}>
                <Link to={'/orders'} className={s.orders}>
                  <svg
                    width="800px"
                    height="800px"
...
77 -33 24 -69 30 -101 18z"
            ...
            <div ref={refMenu} className={s.menu}>
              ...
              {viewMenu && <Menu setViewMenu={setViewMenu} />}
            </div>
          </div>
        </div>
      </header>
